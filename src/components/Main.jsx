    ...
    <div className='w-full h-[550px] text-white'>
      ...
      <div className='absolute w-full h-[550px] bg-gradient-to-r from-black' ></div>
        ...
        <div className='absolute w-full top-[20%] p-4 md:p-8'>
            ...
            <div className='my-4'>
                <button className='border bg-gray-300 py-2 px-5 text-black cursor-pointer'>Play</button>
                <button className='border border-gray-300 py-2 px-5 ml-4 text-white cursor-pointer'>Watch later</button>
            </div>
